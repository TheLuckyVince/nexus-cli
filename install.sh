    ...
    Linux*)
        ...
        case "$(uname -m)" in
            ...
            *)
                ...
                echo "  git clone https://github.com/TheLuckyVince/nexus-cli.git"
...
# -----------------------------------------------------------------------------
LATEST_RELEASE_URL=$(curl -s https://api.github.com/repos/TheLuckyVince/nexus-cli/releases/latest |
